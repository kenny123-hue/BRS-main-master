			...
			<div class="col-lg-10">
				 <h2 class="cd-headline clip is-full-width mb-4 ">
                    ...
                    <span class="cd-words-wrapper text-color">
                        <b class="is-visible">A Health Merchant Account.</b>
                        <b>Digitize Records.</b>
                        <b>Better Service Provision.</b>
                    </span>
                </h2>
                <p>We help you manage and access your patients records easily.<br>Fill the form below and get your service number to get started.</p>
			</div>
		</div>
	</div>
</section>
        ...
        <div class="input_div"> 
          ...
          <hr> 
           ...
           <div class="input_text" > 
            ...
            <div class="input_text" > 
              <input class="last_name" type="text" required name="kra" id="kra"> <label>KRA Pin</label> 
            </div> 
        </div>
