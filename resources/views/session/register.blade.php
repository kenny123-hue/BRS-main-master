      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Kindly create a new account with us for free!</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Phone" name="phone" id="phone" aria-label="Phone" aria-describedby="email-addon" value="{{ old('phone') }}">
                  @error('phone')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
