...
Route::get('terms_of_use', [HomeController::class, 'terms_of_use']);
...
Route::get('auto', [OrgController::class, 'create']);
...
Route::get('auth/google', 'RegisterController@redirectToGoogle');
...
Route::group(['middleware' => 'guest'], function () {
	...
	Route::get('health', [HealthOrgController::class, 'index']);
	Route::post('health', [HealthOrgController::class, 'store']);
